...
describe("Transaction", () => {
  ...
  describe("update()", () => {
    ...
    describe("and the amount is valid", () => {
      ...
      it("Subtracts the amount from the original send output amount", () => {
        expect(transaction.outputMap[senderWallet.publicKey]).toEqual(
      ...
      describe("ande another update for the same recipient", () => {
        let addedAmount;
        ...
        it("subtracts the amount from the originalSenderOutput amount", () => {
          expect(transaction.outputMap[senderWallet.publicKey]).toEqual(
